            ...
            <div className="flex flex-col items-center justify-center w-full">
                <div className="bg-[#1a1a1a] p-6 rounded-lg space-y-6 w-full max-w-2xl">
                    <div className="flex justify-center">
                        <img
                            src={user?.avatar || "/404.webp"} // Fallback image if avatar is not set
                            alt="Profile Picture"
                        ...
                        <div>
                            ...
                            <div className="flex items-center">
                                <input
                                    type="text"
                                    value={user?.username || ""}
                                    className="flex-1 px-4 py-2 rounded-md bg-[#1e1e1e] text-white border border-neutral-700 focus:outline-none"
                                />
                                <button
                        ...
                        <div>
                            ...
                            <div className="flex items-center relative">
                                <input
                                    ...
                                    value={user?.email || ""}
                                    readOnly
                                    className="flex-1 px-4 pr-20 py-2 rounded-md bg-[#1e1e1e] text-white border border-neutral-700 focus:outline-none"
                                />
                                {user?.confirmed ? (
